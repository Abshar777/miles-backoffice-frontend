              ...
              <Card className="bg-white border-slate-200 shadow-sm">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button size="sm" variant="outline" className="h-8 text-xs border-slate-200" onClick={() => { const f = { vendor_id: 'all', category: 'all', transaction_type: 'all', status: 'all' }; setVtFilter(f); setVtPage(1); fetchVendorTransactions(f, 1); }}>
