        ...
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <CardTitle className="text-slate-800 text-base flex items-center gap-2">
              <Receipt className="w-4 h-4 text-blue-600" /> Loan Transactions
                ...
                {loansLoading ? (
                  ...
                  loans.map((loan) => (
                    ...
                    >
                      ...
                      <TableCell className="text-blue-600 text-sm font-mono text-right font-semibold">
                        {(() => {
                    ...
                    item === "..." ? (
                      ...
                      <Button
                        ...
                        className={`w-7 h-7 text-xs border-slate-200 ${
                          page === item ? "text-white bg-blue-600 border-blue-600 hover:bg-blue-700" : "text-slate-500"
                        }`}
