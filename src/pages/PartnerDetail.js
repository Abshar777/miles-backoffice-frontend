            ...
            <Table>
              ...
              <TableBody>
                {txLoading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={8} className="text-center py-8 text-slate-400">No transactions</TableCell>
                  </TableRow>
                ) : (
                  txItems.map((tx) => (
            ...
            <>
              ...
              <div className="border border-slate-200 rounded-lg overflow-hidden max-h-[45vh] overflow-y-auto">
                <Table>
                  ...
                  <TableBody>
                    {drillLoading ? (
                      <TableRow><TableCell colSpan={6} className="text-center py-8 text-slate-400"><Loader2 className="w-4 h-4 animate-spin mx-auto" /></TableCell></TableRow>
                    ) : drillRows.length === 0 ? (
                      <TableRow><TableCell colSpan={6} className="text-center py-8 text-slate-400">No transactions</TableCell></TableRow>
                    ) : drillRows.map((tx) => (
                      <TableRow key={tx.transaction_id}>
                        <TableCell className="font-mono text-xs">{tx.reference || tx.transaction_id}</TableCell>
                        <TableCell className="text-sm">{tx.client_name || tx.client_email || '-'}</TableCell>
