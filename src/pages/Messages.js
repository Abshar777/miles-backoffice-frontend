            ...
            <ScrollArea className="flex-1">
              ...
              <div className="p-2">
                <div className="flex items-center justify-between px-2 py-1 mb-1">
                  ...
                  <button onClick={() => setNewChatDialog(true)} className="w-5 h-5 text-slate-400 hover:text-slate-700 flex items-center justify-center rounded" title="New message">
              ...
              <div className="p-2 border-t">
                <div className="flex items-center justify-between px-2 py-1 mb-1">
                  ...
                  <button onClick={() => setNewChannelDialog(true)} className="w-5 h-5 text-slate-400 hover:text-slate-700 flex items-center justify-center rounded" title="New channel">
                    <Plus className="w-4 h-4" />
                  </button>
                </div>
                {filteredChannels.length === 0 && (
                  <p className="text-xs text-slate-400 px-2 py-1">No channels yet</p>
                )}
