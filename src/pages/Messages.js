                              ...
                              <div className="flex-1 min-w-0 pb-1">
                                ...
                                {!msg.isGrouped && (
                                  <div className="flex items-baseline gap-2 mb-1">
                                    ...
                                    <span className="text-xs text-slate-400">{formatFullTime(msg.created_at)}</span>
                    ...
                    <div className="group flex gap-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-baseline gap-2">
                          ...
                          <span className="text-xs text-slate-400">{formatFullTime(threadMsg.created_at)}</span>
                        </div>
                        {TAG_CHANNELS.includes(selectedChannel?.name) && (
                          <TagChips tags={threadMsg.tags} onTag={(tag) => handleTag(threadMsg, tag)} />
                        )}
                        {threadMsg.content && <p className="text-sm text-slate-800 mt-0.5 whitespace-pre-wrap leading-relaxed">{threadMsg.content}</p>}
                    ...
                    <div key={r.msg_id} className="group flex gap-2.5 mb-3">
                      ...
                      <div className="flex-1 min-w-0 group/rep">
                        <div className="flex items-baseline gap-2">
                          ...
                          <span className="text-xs text-slate-400" title={formatISTFull(r.created_at)}>{formatFullTime(r.created_at)}</span>
