              ...
              <div>
                ...
                {form.transaction_type === "withdrawal" ? (
                  <>
                    ...
                    />
                    <p className="text-[10px] text-slate-400">Locked to the creation date for withdrawals.</p>
                  </>
                ) : (
                  <Input
                    type="date"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-3 text-sm">
              ...
              {(req.client_tags || []).length > 0 && (
                <div className="col-span-2 sm:col-span-4">
                  <span className="text-[10px] text-slate-400 uppercase block mb-1">Client Tags</span>
              ...
              {(req.transaction_tags || []).length > 0 && (
                <div className="col-span-2 sm:col-span-4">
                  <span className="text-[10px] text-slate-400 uppercase block mb-1">Transaction Tags</span>
                  <div className="flex flex-wrap gap-1">
                    {(req.transaction_tags || []).map((tag) => {
                      const tagObj = (txnTags || []).find((t) => t.name === tag)
                        || (txnTags || []).find((t) => t.tag_id === tag);
      ...
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div className="min-w-[120px]">
          ...
          <select
            ...
            className="h-8 text-sm border border-slate-200 rounded px-2 bg-white text-slate-700 w-full"
          >
        ...
        <DialogContent className="bg-white border-slate-200 text-slate-800 max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label className="text-xs text-slate-500 uppercase">
                  CRM Reference <span className="text-slate-400 normal-case">(optional)</span>
                </Label>
                <Input
                  value={form.crm_reference}
                  onChange={(e) =>
                ...
                <label htmlFor="proof-upload" className="cursor-pointer block">
                  {proofPreviews.length > 0 ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-500/60">PNG, JPG, PDF up to 10MB · multiple · or paste (Ctrl/Cmd+V)</p>
                      <PasteButton
                        onFiles={(files) =>
